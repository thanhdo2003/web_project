                                    ...
                                    <tr class="format-text">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="./Images/18-F.png" alt="" style="width: 45px; height: 45px" class="rounded-circle" />
                                            </div>
                                        </td>
                                        <td>
                                            <p class="fw-normal mb-1">William Shakespeare</p>
                                        </td>
                                ...
                                <tbody>
                                    <tr class="format-text">
                                        ...
                                        <td class="format-td">
                                            ...
                                            <div class="format-td-baidang">
                                                <a class="format-baidang" role="button" href="#" class="btn btn-link  btn-rounded">
                                                    Xem bài đăng
                                                </a>
                                            </div>
                                        </td>
