                                ...
                                <div class="row inline-search-form">
                                    <div class="col-sm-5 seach-box">
                                        <div class="input-group form-container mb-3">
                                            ...
                                            <input id="myInput" type="text" name="search-work" class="form-control search-input" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value placeholder="chức danh, từ khóa: lập trình viên, bán hàng,... " autocomplete="off">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="#showUser" style="text-decoration: none; color:white;">
                                        <button onclick="searchFilterFromAdmin()" name="search-main" value="1" class="btn btn-dark btn-outline-light btn-timviec" tabindex="-1" role="button" type="submit">
                                                Tìm
                                        </button>
                                        </a>
                                    </div>
